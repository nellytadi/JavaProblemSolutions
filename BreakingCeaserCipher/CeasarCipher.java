...
public class CeasarCipher {
    ...
    public void testEncrypt(){
       ...
       // System.out.println(decrypt(encrypt("At noon be in the conference room with your hat on for a surprise party. YELL LOUD!",15),15));
    }
    
    public void testEncryptTwoKeys(){
        //System.out.println(decryptTwoKeys("Io iwjv jz dv bcm kjvammmikz mwju edbc twpz pvb wi awm v ncmxmqnm xvzog. TMGT TJCY!",8,21));
